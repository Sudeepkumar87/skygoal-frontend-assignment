  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-8">Add New Product</h1>

        <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
          {/* Product Information Section */}
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">Product Information</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              ...
              <div className="md:col-span-2">
                ...
                {errors.brandCustom && <p className="text-red-600 text-xs mt-1">{errors.brandCustom.message}</p>}
              </div>
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">Image Product</h2>
            <p className="text-xs sm:text-sm text-gray-600 mb-4">
              Note: Format photos SVG, PNG, or JPG (Max size 4mb).
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              {[0, 1, 2, 3].map((index) => (
                <div key={index} className="border-2 border-dashed border-gray-300 rounded-lg p-3 sm:p-4 flex flex-col items-center justify-center min-h-[120px] sm:min-h-[150px] hover:border-blue-400 transition-colors">
                  {images[index] ? (
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pt-4 sm:pt-6 border-t">
            <Link
              href="/product"
              className="px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-medium border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors text-center text-sm sm:text-base"
            >
              Cancel
            </Link>
            <button
              ...
              className="bg-purple-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-medium hover:bg-purple-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              {isSubmitting ? (
                <>
